#!/bin/sh
# Rebuild nassie_0.1.16_all.deb from current source. Run from anywhere;
...
dpkg-deb --build --root-owner-group "$PKG" "$SCRIPT_DIR/nassie_0.1.16_all.deb"
echo "Built $SCRIPT_DIR/nassie_0.1.16_all.deb"
